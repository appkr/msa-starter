...
class PersistentEventPublisherTest {
  ...
  @Autowired private PersistentEventRepository repository;
  @Autowired private PersistentEventPublisher publisher;
  ...
  public void testPublish() throws IOException {
    // given
    final Example eventSource = Example.create("original title");
